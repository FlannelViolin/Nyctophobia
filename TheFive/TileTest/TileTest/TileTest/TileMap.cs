...
namespace TileTest
{
    ...
    class TileMap
    {
        ...
        public TileMap(Texture2D texture, int width, int height, int maxWidth, int maxHeight)
        {
            ...
            //Reset the borders to a wall tile
            for (int k = 0; k < maxHeight; k++)
            {
                _tileInfo[k, 0] = (int)TileType.Wall;
                _tileInfo[k, maxHeight - 1] = (int)TileType.Wall;
                _tileInfo[0, k] = (int)TileType.Wall;
                _tileInfo[maxWidth - 1, k] = (int)TileType.Wall;
            }
        }
